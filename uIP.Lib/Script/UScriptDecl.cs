...
namespace uIP.Lib.Script
{
    ...
    public delegate bool fpClassProvideFunc( out UDataCarrier ret, params UDataCarrier[] ctx );
    public class PluginClassProvideFunc
    {
        public string Description { get; set; } = "";
        public string ReturnValueDescription { get; set; } = "";
        public string[] ArgsDescription { get; set; } = new string[ 0 ];
        public fpClassProvideFunc Call { get; set; } = null;

        public PluginClassProvideFunc() { }
    }
}
